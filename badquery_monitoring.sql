with tb_settings as (
  select
    current_timestamp() - interval 2 hour as search_start_time,
    current_timestamp() as search_finish_time, 
    60 as bucket_time ,
    100000000 as threshold_maximum_slot_ms,
    100000 as threshold_elapsed_ms, 
    1000 as threshold_average_slot_usage, 
...
where
  (elapsed_ms > threshold_elapsed_ms and average_slot_usage > threshold_average_slot_usage)
  or
  (total_slot_ms > threshold_maximum_slot_ms)